...
class GuestbookEntryUnitTests {
	...
	void rejectsEmptyName() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)//
				.isThrownBy(() -> new GuestbookEntry("", "May the 4th be with you!", "yoda@xD.de"));
	}
	...
	void rejectsEmptyText() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)//
				.isThrownBy(() -> new GuestbookEntry("Ollie", "", "yoda@xD.de"));
	}
	...
	void setsCreationDate() {
		assertThat(new GuestbookEntry("Ollie", "May the 4th be with you!", "yoda@xD.de")
				.getDate()).isNotNull();
	}
}
