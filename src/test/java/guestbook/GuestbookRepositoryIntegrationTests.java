...
class GuestbookRepositoryIntegrationTests {
	...
	void persistsGuestbookEntry() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!", "yoda@gmx.de"));
	...
	@Test // #34
	void findsGuestbookEntryByText() {

		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "maderja", "yoda@gmx.de"));

		assertThat(repository.findByText("maderja")).contains(entry);
	}
}
